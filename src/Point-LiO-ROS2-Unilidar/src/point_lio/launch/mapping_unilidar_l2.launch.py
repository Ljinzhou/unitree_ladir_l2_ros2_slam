...
def generate_launch_description():
    ...
    laser_mapping_params = [
        ...
        ]),
        {
            ...
            'check_satu': True,
            'init_map_size': 10,
            'point_filter_num': 2,  # increased for more stable filtering
            'space_down_sample': True,
            'filter_size_surf': 0.2,  # increased for more stable surface filtering
            'filter_size_map': 0.2,  # increased for more stable map filtering
            'cube_side_length': 500.0,  # reduced for better local mapping
